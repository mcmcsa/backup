...
import 'work_request_completion_web.dart';
import 'admin_pre_inspection_review_web.dart';

class RequestDetailsPageWeb extends StatefulWidget {
  final WorkRequest request;

  const RequestDetailsPageWeb({super.key, required this.request});

  @override
  State<RequestDetailsPageWeb> createState() => _RequestDetailsPageState();
}

class _RequestDetailsPageState extends State<RequestDetailsPageWeb> {
  WorkRequest get request => widget.request;
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WorkRequestCompletionPageWeb(
                            request: request,
                          ),
                        ),
                      );
