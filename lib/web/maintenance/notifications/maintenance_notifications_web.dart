...
class MaintenanceNotificationsWeb extends StatefulWidget {
  const MaintenanceNotificationsWeb({super.key});

  @override
  State<MaintenanceNotificationsWeb> createState() => _MaintenanceNotificationsWebState();
}

class _MaintenanceNotificationsWebState extends State<MaintenanceNotificationsWeb> {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          MaintenanceNavController.of(context)?.navigateTo(5);
                        },
  ...
  Widget _buildPageHeader() {
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 6),
        Text(
          'Stay updated on your assigned tasks and message notifications.',
          style: TextStyle(
            fontSize: 14,
            color: _subtleText,
