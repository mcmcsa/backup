        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // View Work Process button for all non-pending statuses
              if (request.status != 'pending') ...[
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
              ...
              ElevatedButton.icon(
                onPressed: (request.status == 'done' || request.status == 'completed') ? () {
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: (request.status == 'done' || request.status == 'completed') ? const Color(0xFF4169E1) : Colors.grey.shade300,
                  foregroundColor: (request.status == 'done' || request.status == 'completed') ? Colors.white : Colors.grey.shade600,
                  minimumSize: const Size(double.infinity, 50),
