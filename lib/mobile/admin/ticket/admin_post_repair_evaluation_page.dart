    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Post-repair approved. Waiting for requestor final confirmation signature.',
            ),
          ...
          : ListView(
              ...
              children: [
                ...
                _buildSection('TECHNICIAN DETAILS', [
                  ...
                  _buildInfoRow(
                    'Duration',
                    report.repairDuration ?? 'Not recorded',
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        const Text(
                          'If the maintenance work is not satisfactory, provide notes and send back for rework.',
                          style: TextStyle(
                            fontSize: 12,
                            color: Color(0xFF6B7280),
                          ),
