...
class _AddRoomPageState extends State<AddRoomPage> {
  ...
  void _generateQRCode() {
    if (_nameController.text.isEmpty || _buildingController.text.isEmpty) {
    ...
    final qrData = 'PSU-ROOM-${_nameController.text}-${_buildingController.text}-${const Uuid().v4().substring(0, 8)}';
    setState(() {
      _qrGenerated = true;
  ...
  void _performSave() async {
    ...
    try {
      ...
      final qrData = _generatedQrData.isNotEmpty
          ? _generatedQrData
          : 'PSU-ROOM-${_nameController.text}-$buildingName-${roomId.substring(0, 8)}';
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        '${_buildingController.text} • $_selectedFloor',
                        style: TextStyle(
                          fontSize: 12,
